...
<div class="card-body">
    <form method="POST" action="{{ route('register') }}">
      ...
      <div class="row mb-3">
                            ...
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Nama Pengguna') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('Masukkan Password') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Masukkan Password Lagi') }}</label>
